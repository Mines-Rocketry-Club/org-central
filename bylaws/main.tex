...
\todo{Provisions for tracking membership to be handled in policies}
\section{Officers}
\label{officers}
...
\paragraph{Quorum}
\todo{Change to officer-based definition}{Two-Thirds (2/3) of the regular members} of the organization shall constitute a quorum for the transaction of official business. 
